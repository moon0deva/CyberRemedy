...
FRAMEWORKS = {
    ...
    "ISO_27001": {
        ...
        "controls": [
            {"id": "A.5.1",  "title": "Policies for information security",       "mitre_ids": [],        "check_fn": "check_logging",         "weight": 2},
            {"id": "A.6.1",  "title": "Screening and security roles",             "mitre_ids": ["T1078"], "check_fn": "check_auth_monitoring",  "weight": 2},
            {"id": "A.8.1",  "title": "Inventory of information and assets",      "mitre_ids": [],        "check_fn": "check_agent_inventory",  "weight": 3},
            {"id": "A.8.8",  "title": "Management of technical vulnerabilities",  "mitre_ids": [],        "check_fn": "check_vuln_management",  "weight": 3},
            {"id": "A.8.15", "title": "Logging",                                  "mitre_ids": [],        "check_fn": "check_logging",          "weight": 3},
            {"id": "A.8.16", "title": "Monitoring activities",                    "mitre_ids": ["T1046"], "check_fn": "check_network_monitoring","weight": 3},
            {"id": "A.8.19", "title": "Installation of software",                 "mitre_ids": [],        "check_fn": "check_yara_active",      "weight": 2},
            {"id": "A.8.22", "title": "Segregation of networks",                  "mitre_ids": [],        "check_fn": "check_firewall_rules",   "weight": 2},
            {"id": "A.5.26", "title": "Response to information security incidents","mitre_ids": [],        "check_fn": "check_soc_response",     "weight": 3},
            {"id": "A.5.27", "title": "Learning from incidents",                  "mitre_ids": [],        "check_fn": "check_case_management",  "weight": 2},
        ],
    },
    "GDPR": {
        "name": "GDPR Security Requirements",
        "controls": [
            {"id": "Art.25", "title": "Data protection by design and by default",  "mitre_ids": [],        "check_fn": "check_secure_config",    "weight": 3},
            {"id": "Art.32", "title": "Security of processing — encryption/pseudonymisation", "mitre_ids": [], "check_fn": "check_logging",      "weight": 3},
            {"id": "Art.33", "title": "Notification of personal data breach",       "mitre_ids": [],        "check_fn": "check_soc_response",     "weight": 3},
            {"id": "Art.35", "title": "Data protection impact assessment",          "mitre_ids": [],        "check_fn": "check_risk_scoring",     "weight": 2},
            {"id": "Art.5a", "title": "Lawfulness and data minimisation",           "mitre_ids": [],        "check_fn": "check_case_management",  "weight": 2},
            {"id": "Art.5f", "title": "Integrity and confidentiality",              "mitre_ids": ["T1041"], "check_fn": "check_network_monitoring","weight": 3},
            {"id": "Art.83", "title": "Breach detection within 72 hours",           "mitre_ids": [],        "check_fn": "check_alert_review",     "weight": 3},
        ],
    },
    "SOC2_TYPE2": {
        "name": "SOC 2 Type II — Trust Services Criteria",
        "controls": [
            {"id": "CC6.1",  "title": "Logical access security controls",          "mitre_ids": ["T1078"], "check_fn": "check_auth_monitoring",  "weight": 3},
            {"id": "CC6.6",  "title": "Logical access restriction",                "mitre_ids": [],        "check_fn": "check_firewall_rules",   "weight": 3},
            {"id": "CC6.8",  "title": "Malware and unauthorized software detection","mitre_ids": [],        "check_fn": "check_yara_active",      "weight": 3},
            {"id": "CC7.1",  "title": "System monitoring",                         "mitre_ids": ["T1046"], "check_fn": "check_network_monitoring","weight": 3},
            {"id": "CC7.2",  "title": "Threat and vulnerability identification",    "mitre_ids": [],        "check_fn": "check_vuln_management",  "weight": 3},
            {"id": "CC7.3",  "title": "Evaluation of security events",             "mitre_ids": [],        "check_fn": "check_alert_review",     "weight": 3},
            {"id": "CC7.4",  "title": "Incident response",                         "mitre_ids": [],        "check_fn": "check_soc_response",     "weight": 3},
            {"id": "CC7.5",  "title": "Remediation and recovery",                  "mitre_ids": [],        "check_fn": "check_case_management",  "weight": 2},
            {"id": "A1.2",   "title": "Availability — performance monitoring",     "mitre_ids": [],        "check_fn": "check_logging",          "weight": 2},
            {"id": "PI1.1",  "title": "Processing integrity monitoring",            "mitre_ids": [],        "check_fn": "check_ids_active",       "weight": 2},
        ],
    },
    "NIST_CSF": {
        "name": "NIST Cybersecurity Framework 1.1",
        "controls": [
            {"id": "ID.AM",  "title": "Asset Management — inventory of devices",   "mitre_ids": [],        "check_fn": "check_agent_inventory",  "weight": 3},
            {"id": "ID.RA",  "title": "Risk Assessment — vulnerability identification","mitre_ids": [],      "check_fn": "check_vuln_management",  "weight": 3},
            {"id": "PR.AC",  "title": "Identity Management and Access Control",    "mitre_ids": ["T1078"], "check_fn": "check_auth_monitoring",  "weight": 3},
            {"id": "PR.DS",  "title": "Data Security — data-at-rest protection",   "mitre_ids": [],        "check_fn": "check_fim",              "weight": 2},
            {"id": "PR.IP",  "title": "Information Protection Processes",          "mitre_ids": [],        "check_fn": "check_secure_config",    "weight": 2},
            {"id": "DE.AE",  "title": "Anomalies and Events detection",            "mitre_ids": [],        "check_fn": "check_ids_active",       "weight": 3},
            {"id": "DE.CM",  "title": "Security Continuous Monitoring",            "mitre_ids": ["T1046"], "check_fn": "check_network_monitoring","weight": 3},
            {"id": "DE.DP",  "title": "Detection Processes — MITRE ATT&CK mapping","mitre_ids": [],        "check_fn": "check_detection_coverage","weight": 2},
            {"id": "RS.RP",  "title": "Response Planning",                         "mitre_ids": [],        "check_fn": "check_soc_response",     "weight": 3},
            {"id": "RS.CO",  "title": "Communications — incident coordination",    "mitre_ids": [],        "check_fn": "check_case_management",  "weight": 2},
            {"id": "RC.RP",  "title": "Recovery Planning",                         "mitre_ids": [],        "check_fn": "check_logging",          "weight": 2},
        ],
    },
    "CIS_V8": {
        ...
        "controls": [
            ...
            {"id": "CIS-3",  "title": "Data Protection",
             "mitre_ids": ["T1041"], "check_fn": "check_network_monitoring", "weight": 3},
            {"id": "CIS-4",  "title": "Secure Configuration of Enterprise Assets",
             "mitre_ids": [], "check_fn": "check_secure_config", "weight": 2},
            ...
            {"id": "CIS-16", "title": "Application Software Security",
             "mitre_ids": ["T1190"], "check_fn": "check_vuln_management", "weight": 2},
            ...
            {"id": "CIS-18", "title": "Penetration Testing",
             "mitre_ids": [], "check_fn": "check_detection_coverage", "weight": 2},
        ],
    },
    "NIST_CSF_2": {
        "name": "NIST Cybersecurity Framework 2.0",
        "controls": [
            {"id": "GV.OC",  "title": "Organizational Context — mission and stakeholders",
             "mitre_ids": [], "check_fn": "check_case_management", "weight": 2},
            ...
            {"id": "ID.AM",  "title": "Asset Management",
             "mitre_ids": [], "check_fn": "check_agent_inventory", "weight": 3},
            {"id": "ID.RA",  "title": "Risk Assessment",
             "mitre_ids": [], "check_fn": "check_vuln_management", "weight": 3},
            {"id": "ID.IM",  "title": "Improvement — lessons learned",
             "mitre_ids": [], "check_fn": "check_case_management", "weight": 2},
            {"id": "PR.AA",  "title": "Identity Management Authentication and Access Control",
             "mitre_ids": ["T1078"], "check_fn": "check_auth_monitoring", "weight": 3},
            {"id": "PR.AT",  "title": "Awareness and Training",
             "mitre_ids": [], "check_fn": "check_logging", "weight": 2},
            {"id": "PR.DS",  "title": "Data Security",
             "mitre_ids": ["T1041"], "check_fn": "check_network_monitoring", "weight": 3},
            {"id": "PR.PS",  "title": "Platform Security — config management",
             "mitre_ids": [], "check_fn": "check_secure_config", "weight": 2},
            {"id": "PR.IR",  "title": "Technology Infrastructure Resilience",
             "mitre_ids": [], "check_fn": "check_logging", "weight": 2},
            {"id": "DE.CM",  "title": "Continuous Monitoring",
             "mitre_ids": ["T1046"], "check_fn": "check_network_monitoring", "weight": 3},
            {"id": "DE.AE",  "title": "Adverse Event Analysis",
             "mitre_ids": [], "check_fn": "check_ids_active", "weight": 3},
            {"id": "RS.MA",  "title": "Incident Management",
             "mitre_ids": [], "check_fn": "check_soc_response", "weight": 3},
            {"id": "RS.AN",  "title": "Incident Analysis",
             "mitre_ids": [], "check_fn": "check_alert_review", "weight": 3},
            {"id": "RS.CO",  "title": "Incident Response Reporting",
             "mitre_ids": [], "check_fn": "check_case_management", "weight": 2},
            {"id": "RS.MI",  "title": "Incident Mitigation",
             "mitre_ids": [], "check_fn": "check_firewall_rules", "weight": 3},
    ...
    "MITRE_DEFEND": {
        "name": "MITRE ATT&CK Defensive Coverage",
        "controls": [
            {"id": "TA0001", "title": "Initial Access — coverage of entry vectors",
             "mitre_ids": ["T1190","T1566","T1133"], "check_fn": "check_ids_active", "weight": 3},
            {"id": "TA0002", "title": "Execution — detection of malicious execution",
             "mitre_ids": ["T1059","T1203"], "check_fn": "check_yara_active", "weight": 3},
            {"id": "TA0003", "title": "Persistence — detection of persistence mechanisms",
             "mitre_ids": ["T1547","T1053","T1546"], "check_fn": "check_sigma_active", "weight": 3},
            {"id": "TA0004", "title": "Privilege Escalation",
             "mitre_ids": ["T1068","T1548"], "check_fn": "check_ids_active", "weight": 3},
            {"id": "TA0005", "title": "Defense Evasion",
             "mitre_ids": ["T1070","T1027"], "check_fn": "check_detection_coverage", "weight": 2},
            {"id": "TA0006", "title": "Credential Access",
             "mitre_ids": ["T1003","T1110","T1558"], "check_fn": "check_auth_monitoring", "weight": 3},
            {"id": "TA0007", "title": "Discovery",
             "mitre_ids": ["T1046","T1082","T1087"], "check_fn": "check_network_monitoring", "weight": 2},
            {"id": "TA0008", "title": "Lateral Movement",
             "mitre_ids": ["T1021","T1047","T1550"], "check_fn": "check_network_monitoring", "weight": 3},
            {"id": "TA0009", "title": "Collection",
             "mitre_ids": ["T1560","T1005"], "check_fn": "check_ids_active", "weight": 2},
            {"id": "TA0010", "title": "Exfiltration",
             "mitre_ids": ["T1041","T1048"], "check_fn": "check_network_monitoring", "weight": 3},
            {"id": "TA0011", "title": "Command and Control",
             "mitre_ids": ["T1071","T1095"], "check_fn": "check_ids_active", "weight": 3},
            {"id": "TA0040", "title": "Impact — ransomware and disruption detection",
             "mitre_ids": ["T1486","T1490"], "check_fn": "check_yara_active", "weight": 3},
        ],
    },
}
